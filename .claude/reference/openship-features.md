...
- 2026-09-09 전체 페이지 반응형: Container px-4→sm:px-6 · AppShell py-6→sm:py-8 · Card p-5→sm:p-6 · TopBar 이름 truncate · PageHeading 은 좁으면 동작이 제목 아래 · 띠는 `@container`/`@3xl` 로 768 기준 2열↔1열. 420·640·820·1024·1280 다섯 폭에서 가로 넘침 0.
