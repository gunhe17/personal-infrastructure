import { Avatar, SideNav, StatusDot, AppShell, AreaChart, Card, cn, DeviceList, Dot, formatGB as GB, formatGBShort as AX, IconText, NOW, PageHeading, Progress, SectionHeading, Sparkline } from "@/ui";
...
export function StorageLab() {
  return (
    <AppShell nav={<SideNav projects={PROJECTS} project="api" items={ITEMS} item="storage" system={SYSTEM} status={<StatusDot tone="running">edge up</StatusDot>} user={<Avatar name="gunhee" size={32} />} />}>
