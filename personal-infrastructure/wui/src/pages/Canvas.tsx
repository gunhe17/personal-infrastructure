...
const ITEMS: Item[] = [
  ...
  // 표면
  { id: "empty", label: "EmptyState", render: () => <Card className="p-0"><EmptyState title="아직 프로젝트가 없습니다" action={<Button variant="primary" size="sm">새 프로젝트</Button>}>서버에서 <InlineCode>pi project create</InlineCode> 로 만들어도 여기 나타납니다.</EmptyState></Card> },
