...
const SECTIONS: RowDef[] = [
  ...
  { title: "3 유기체", cells: [
    ...
    { title: "리소스", items: ["o-band", "o-bands", "o-devices", "o-storage"] },
  ] },
  { title: "4 템플릿", cells: [
