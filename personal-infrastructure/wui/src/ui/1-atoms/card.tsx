...
export function Card({ title, subtitle, icon, actions, footer, className, children, ...props }: React.ComponentProps<"section"> & { title?: React.ReactNode; subtitle?: React.ReactNode; icon?: React.ReactNode; actions?: React.ReactNode; footer?: React.ReactNode }) {
  return (
    <section className={cn("rounded-card bg-card p-5 sm:p-6", className)} {...props}>
      {(title || actions) && (
