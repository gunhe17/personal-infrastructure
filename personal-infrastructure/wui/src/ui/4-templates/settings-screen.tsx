...
export function SettingsScreen() {
  ...
  return (
    <AppShell nav={<SideNav projects={PROJECTS} project="api" items={ITEMS} item="settings" system={SYSTEM} status={<StatusDot tone="running">edge up</StatusDot>} profile={{ name: "gunhee", sub: "admin" }} />}>
