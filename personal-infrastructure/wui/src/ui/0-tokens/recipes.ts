...
/** 작은 세그먼트 — 트랙 p-1 안에서 32 높이. 칸은 flex-1 로 같은 폭이라 좁은 열에서도 트랙 폭에 맞춘다(띠 안의 합·읽기·쓰기 토글). */
export const SEG_SM = "relative z-10 inline-flex h-6 flex-1 shrink-0 items-center justify-center gap-1.5 min-w-0 whitespace-nowrap rounded-[8px] px-2 text-caption font-medium text-mute segment hover:text-text";
