...
export const SEG_SM = "relative z-10 inline-flex h-6 flex-1 shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-[8px] px-1 text-caption font-medium text-mute segment hover:text-text";
