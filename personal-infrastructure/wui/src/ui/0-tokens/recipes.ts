...
/** 세그먼트 칸 — 트랙 p-1 안에서 32 라 바깥이 버튼과 같은 40(2026-09-09: 40 이던 것을 32 로, 트랙이 48 이 되어 규격과 어긋났다). */
export const SEG = "relative z-10 inline-flex h-8 shrink-0 items-center gap-2 rounded-button px-4 text-body font-medium text-mute segment hover:text-text";
